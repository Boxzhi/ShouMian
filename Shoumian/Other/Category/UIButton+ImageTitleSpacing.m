...
- (void)setTitleAndColor{
    [self setImage:[UIImage imageNamed:@"home_into"] forState:UIControlStateNormal];
...
- (void)setXialaMenuButton{
    [self setImage:[UIImage imageNamed:@"home_xiala"] forState:UIControlStateNormal];
    [self.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [self setTitleColor:UIColor666 forState:UIControlStateNormal];
